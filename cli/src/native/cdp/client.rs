...
/// Compare flattened CDP event routing with an active session. Direct page
/// connections represent their root session as an empty string while Chrome
/// omits `sessionId` from the corresponding events.
pub(crate) fn cdp_session_matches(
